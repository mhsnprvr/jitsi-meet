...
import { BREAKOUT_ROOMS_BUTTON_ENABLED } from "../../../base/flags/constants";
...
const ParticipantsPaneFooter = (): JSX.Element => {
    ...
    return (
        <View style={styles.participantsPaneFooterContainer as ViewStyle}>
            {isBreakoutRoomsSupported && isBreakoutRoomsEnabled && (
                <Button
                    accessibilityLabel="participantsPane.actions.breakoutRooms"
                    // eslint-disable-next-line react/jsx-no-bind, no-confusing-arrow
                    icon={() => <Icon color={BaseTheme.palette.icon04} size={20} src={IconRingGroup} />}
